...
graph TD;
    ...
    TOPHIT_SPECIAL_NTM{{Is top hit in this list:<br/>M.intracellulare_chimaera,
    M.avium_hominissuis,<br/>M.paraintracellulare,<br/>M.intracellulare,<br/>M.lepraemurium,<br/>M.abscessus?}};
