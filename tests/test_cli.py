...
def test_Argument_individual_reports(all_reports_set_individually):
...
def test_Argument_four_reports(four_reports):
...
def test_Argument_three_reports(three_reports):
...
def test_Argument_one_report(one_report):
